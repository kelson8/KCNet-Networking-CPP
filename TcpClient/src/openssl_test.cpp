 ...
 * TODO Test this
 */
EVP_PKEY &OpensslTest::CreatePrivateKey()
{
...
bool OpensslTest::Encrypt(const unsigned char *plaintext,
                          int plaintext_len,
...
bool OpensslTest::Decrypt(const unsigned char *ciphertext,
                          int ciphertext_len,
                          const unsigned char *key,
                          const unsigned char *iv,
 ...
 */
// void OpensslTest::ReadPrivateKey(const char *privateKeyFile)
std::string OpensslTest::ReadPrivateKey(const char *privateKeyFile)
{
 ...
 */
void OpensslTest::PublicKeyTesting()
{
